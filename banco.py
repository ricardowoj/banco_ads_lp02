...
# AC03 ADS-EaD - Banco
#
# Email: ricardo.wojciechowski@aluno.faculdadeimpacta.com.br
...
class Banco():
    ...
    def abre_conta(self, clientes: List[Cliente], saldo_ini: Number) -> None:
        ...
        numero_conta_nova = len(self.__contas) + 1
        criacao_conta = Conta(clientes, numero_conta_nova, saldo_ini)
        self.__contas.append(criacao_conta)
